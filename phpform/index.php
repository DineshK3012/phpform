<?php 
    session_start();
    $_SESSION['TimerStarts'] = true;
    $_SESSION['now'] = time();
    $_SESSION['then'] = time() + (3 * 60);
?>
...
<head>
    ...
    <title>Form With Captcha & Timer</title>
...
<body>
    ...
    <div class="form-btn">
        <button id="btn">Open Form</button>
    ...
    $(document).ready(function() {
        $('#btn').click(function() {
            ...
            let showTimer = $(document.createElement('p'));
            showTimer.appendTo('.timer');
